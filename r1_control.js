...
['切换官方氛围效果',{url:ip+'/send_message',param:{what:4,arg1:67,arg2:0},type:0,min_ver:1500,succ:'已切换为官方氛围效果！'}],
['切换七彩氛围效果',{url:ip+'/send_message',param:{what:4,arg1:67,arg2:1},type:0,min_ver:1500,succ:'已切换为七彩氛围效果！'}],
...
function index(){
	...
	for(var i=0;i<buttons.length;i++){
		if(ver+1 > buttons[i][1].min_ver || buttons[i][1].min_ver == null){
