	...
	if(ver+1 > 1856){
		...
		var quality_div = document.createElement('div');
            ...
            if(music_info != null){
                ...
                if((music_id != music_info.id && data.play_type != 2) || (data.play_type == 2 && music_info.title + '-' + music_info.artist + '-' + music_info.albumUrl != music_id) || data.play_type == 4 && data.play_type != 0){
					info_time = [];
					lrcs = [[-1,'暂无歌词']];
					if(data.play_type == 2){
